...
%Denoising
%dayI
[k_dayI]=ImageDenoising(gray_dayI_rngmap,1,1,sunset_time,sunrise_time,daycof);
%Night
[k_night]=ImageDenoising(gray_night_rngmap,1,2,sunset_time,sunrise_time,nightcof);
%dayII
[k_dayII]=ImageDenoising(gray_dayII_rngmap,1,3,sunset_time,sunrise_time,daycof);
